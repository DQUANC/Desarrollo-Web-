...
namespace Core.Servicios
{
    public class RabbitMQServicio : IRabbitMQ
    {
        ...
        private readonly IMongoCollection<MensajeMongoServicio> _mensajeMongo;
        public RabbitMQServicio(IConfiguration configuration)
        {
            ...
            _mensajeMongo = mongoDatabase.GetCollection<MensajeMongoServicio>("PAGOS");
        }
        ...
        public async Task EncolarSolicitudPago(long idSolicitudPago)
        {
            ...
            // REGISTRO EN MONGODB
            var mensajeMongo = new MensajeMongoServicio
            {
