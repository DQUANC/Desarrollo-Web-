    ...
    public class ClienteServicio: ICliente
    {
        ...
        public async Task<List<MCliente>> ObtenerTodos()
        {
            try
            {
                ...
                var resultado =
                    await connection.QueryAsync<MCliente>(sql);
            ...
            {
                Console.WriteLine(
                    "Error al obtener clientes: " + ex.Message);
        ...
        public async Task<MCliente?> ObtenerPorId(int id)
        {
            try
            {
                ...
                var resultado =
                    await connection.QueryFirstOrDefaultAsync<MCliente>(
                        sql,
                        new { IdCliente = id });
            ...
            {
                Console.WriteLine(
                    "Error al obtener cliente por ID: " + ex.Message);

                return null;
            }
        }

        public async Task<MCliente?> ObtenerPorDpi(string dpi)
        {
            try
            {
                const string sql = @"
            ...
            {
                Console.WriteLine(
                    "Error al obtener cliente por DPI: " + ex.Message);
        ...
        public async Task<bool> CambiarEstado(int id, bool estado)
        {
            ...
            {
                Console.WriteLine(
                    "Error al cambiar estado del cliente: " + ex.Message);
